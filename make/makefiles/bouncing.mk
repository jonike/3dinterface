...
$(MODULES)/server/lib/static/js/bouncing.min.js: $(call FIND,$(MODULES)/bouncing-cube/src/,*) $(MODULES)/bouncing-cube/node_modules/.dirstamp $(MODULES)/bouncing-cube/tsconfig.json $(MODULES)/bouncing-cube/typings $(MODULES)/bouncing-cube/config.js
	@$(call LOG_BUILDING,bouncing-cube)
	@$(NODE) $(MODULES)/bouncing-cube/config.js
	@$(call LOG_BUILT,bouncing-cube)

BOUNCING_CUBE_DEPENDENCY=$(MODULES)/server/lib/static/js/bouncing.min.js
