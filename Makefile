...
clean: clean-global clean-l3d clean-l3dp clean-server clean-demo clean-mth clean-bouncing-cube clean-config clean-analysis clean-replay clean-lock

clean-lock:
	@$(RMRF) $(call FIND,.,package-lock.json)
